...
export const workData = [
  ...
  },
  {
    ...
    title: "MUA",
    categories: ["Web App"],
    description: "MUA adalah website landing page yang di buat untuk jasa Make Up Artist yang langsung bisa konsultasi dan booking by whatsapp. Desain ini berfokus pada tampilan yang clean dan modern dan simple agar orang bisa gampang meggunakan dan memahami jasa apa yang ditawarkan.",
  ...
  },
  {
    ...
    title: "Portfolio-v1",
    categories: ["Web App"],
    description: "Portofolio ini adalah portfolio pribadi versi lama saya. yang di buat tahun 2025",
  ...
  },
  {
    ...
    title: "Portfolio-v2",
    categories: ["Web App"],
    description: "Portofolio ini adalah portfolio yang di gunakan oleh saya saat ini. yang di buat tahun 2026.",
    tech: ["Next js", "Tailwind", "Typescript"],
