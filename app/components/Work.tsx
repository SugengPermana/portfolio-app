            ...
            return (
              <div 
                ...
                className={cn(
                  ...
                  isActive 
                    ? "bg-card border-border shadow-xl h-auto p-8" 
                    : "bg-transparent border-transparent hover:border-border p-4 h-[72px] flex items-center"
                )}
              >
                {!isActive ? (
                  ...
                  >
                    ...
                    <div className="flex gap-4 pt-4 mt-auto">
                      <a 
                        href={work.githubUrl} 
                        className="flex items-center gap-2 px-6 py-3 rounded-full border border-border font-medium hover:bg-muted transition-colors text-sm"
                      >
             ...
             <div className="bg-card border border-border rounded-3xl p-2 pb-6 shadow-2xl overflow-hidden">
               ...
               <div className="flex items-center gap-2 px-4 py-3 border-b border-border mb-2 bg-muted/30">
                 ...
                 <div className="mx-auto px-4 py-1.5 rounded-md bg-background border border-border text-xs text-muted-foreground font-mono truncate w-2/3 text-center opacity-70">
                   https://github.com/darrellrafa/{activeProject?.title.replace(/\s+/g, '')}
                 </div>
               </div>
